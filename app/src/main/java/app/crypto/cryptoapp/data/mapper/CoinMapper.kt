package app.crypto.cryptoapp.data.mapper

import app.crypto.cryptoapp.data.database.CoinInfoDbModel
import app.crypto.cryptoapp.data.network.model.CoinInfoDto
